...
class Company extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, name, business_license, tax_license, code_license, isVerified', 'required'),
			array('id, isVerified', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>15),
			array('business_license, tax_license, code_license', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, business_license, tax_license, code_license, isVerified', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('tax_license',$this->tax_license,true);
